...
===================
**ImageAI** nécessite que vous ayez Python 3.5.1 ou supérieur installe ainsi que d'autres librairies et bibliothèques python. Avant de procéder a l'installation de **ImageAI** vous devez installer les éléments suivantsÊ:  
...
Une fois que **ImageAI** est installé, vous pouvez en quelques lignes de code accomplir les t‰ches de vision assistée par ordinateur les plus puissantes comme vous pouvez le voir ci-dessous.  
